...
class OpenthreadService(Service):
    ...
    def __init__(self, bus, index, wpantun):
        ...
        self.add_characteristic(OpenthreadChannelCharacteristic(bus, 0, self, wpantun))
        self.add_characteristic(OpenthreadNameCharacteristic(bus, 1, self, wpantun))
        self.add_characteristic(OpenthreadPanIDCharacteristic(bus, 2, self, wpantun))
        self.add_characteristic(OpenthreadXPanIDCharacteristic(bus, 3, self, wpantun))
        self.add_characteristic(OpenthreadMasterKeyCharacteristic(bus, 4,
                                                                  self, wpantun))
        self.add_characteristic(OpenthreadStateCharacteristic(bus, 5, self, wpantun))
        self.add_characteristic(OpenthreadMeshIPv6Characteristic(bus, 6, self, wpantun))
